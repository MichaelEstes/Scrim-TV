...
REGION=us-east-2
TRANSCODINGINGRESSBUCKET=scrim-ingestion
TRANSCODINGEGRESSBUCKET=scrim-vod
TRANSCODINGQUEUE=https://amazonaws.com/Queue ID/Scrim-Transcoding-Queue
NUMPROCS=$(nproc)
...
while sleep 5; do 
  ...
  JSON=$(aws sqs --output=json receive-message --queue-url $TRANSCODINGQUEUE --region $REGION)
